...
public class AdminControllerServlet extends HttpServlet {
	...
	private DbRetrieveService dbRetrieve;
	...
	public void init() throws ServletException {
		...
		try {
			dbRetrieve = new DbRetrieveService(datasource);
	...
	private void login(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (username.toLowerCase().equals("admin") && password.toLowerCase().equals("password")) {
	...
	private boolean getCookies(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		for (Cookie cookie : cookies) {
			...
			if (cookie.getName().equals("admin") && cookie.getValue().equals("password")) {
				check = true;
				break;
			} 
		}
